...
const HyperactivityAdvice = () => {
  const navigate = useNavigate();

  return (
    <div className="min-h-[150vh] flex justify-center items-center h-screen bg-gradient-to-r from-blue-200 via-purple-200 to-purple-300">
      <div className="bg-[#F5F1E9] p-5 rounded-lg shadow-2xl text-center w-[1400px] ">
        <div className="mb-4">
          <h2 className="text-3xl font-bold text-[#6a5acd]">Control Hyperactivity of Your Kid</h2>
        </div>
        ...
        🤸 Make time for exercise every day whether it’s running, biking, or playing outside. Physical activity helps your child release extra energy and improves their ability to concentrate. / දිවීම, බයිසිකල් පැදීම හෝ එළිමහනේ සෙල්ලම් කිරීම වැනි සෑම දිනකම ව්‍යායාම සඳහා කාලය වෙන් කරන්න. ශාරීරික ක්‍රියාකාරකම් ඔබේ දරුවාට අමතර ශක්තියක් මුදා හැරීමට සහ අවධානය යොමු කිරීමේ හැකියාව වැඩි දියුණු කිරීමට උපකාරී වේ.<br /><br />
  ...
  <br />
  •{" "}
  <a href="https://www.psytoolkit.org/experiment-library/experiment_go-no-go.html" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">
 Go/NoGo
  </a>
  <br />
  •{" "}
  <a href="https://youtu.be/RiMb2Bw4Ae8?si=OPFRBTDkTS2HYYSP" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">
  Belly Breathing: Mindfulness for Children
  </a>
  <br />
  •{" "}
  <a href="/control-impulsiveness" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800">
  NeuroAssist Control Hyperactivity Game
</a>
...
export default HyperactivityAdvice;