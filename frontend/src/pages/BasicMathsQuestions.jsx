...
//       iconColor: "#FF6347", // Tomato red icon
//     }).then(() => {
//       setShowGame(true); // Show the game after the user clicks OK
//       setStartTime(Date.now()); // Start timer when component mounts
//     });
...
//       {showGame && ( // Only show the game if `showGame` is true
//         <div className="bg-gradient-to-r from-yellow-300 to-pink-300 max-w-md w-full p-6 rounded-2xl shadow-2xl">
//           {endTime ? (
//             <div className="text-center">
...
//                 </button>
//                 <button
//                   onClick={() => navigate("/NonEducationalActivity")}
...
//           ) : (
//             <div>
//               <h1 className="text-4xl font-bold text-purple-800 mb-4">Math Game for Kids 🧮</h1>
//               <h2 className="text-2xl text-blue-800 mb-2">
//                 Question {currentIndex + 1} / 10
//               </h2>
//               <h2 className="text-2xl text-green-800 mb-4">Score: {score} / 100</h2>
...
//                   onChange={(e) => setAnswer(e.target.value)}
//                   placeholder="Enter Answer"
//                   className="w-full p-3 border-2 border-purple-300 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 text-center text-2xl"
//                 />
//               </div>
//               <button
//                 onClick={handleSubmit}
//                 className="w-full bg-purple-500 text-white px-6 py-3 rounded-full hover:bg-purple-600 transition-colors text-2xl shadow-lg"
//               >
//                 Submit ✅
//               </button>
//             </div>
...
const MathGame = () => {
  ...
  useEffect(() => {
    ...
    Swal.fire({
      title: "Hey Buddy!",
      text: "You have to complete an interest math game. Click OK to start.",
      icon: "info",
      confirmButtonText: "OK",
      ...
      {showGame && ( // Only show the game if `showGame` is true
        <div className="bg-gradient-to-r from-yellow-300 to-pink-300 max-w-md w-full p-6 rounded-2xl shadow-2xl">
          {endTime ? (
            ...
            <div>
              <h1 className="text-4xl font-bold text-purple-800 mb-4">Math Game for you 🧮</h1>
              <h2 className="text-2xl text-blue-800 mb-2">
                Question {currentIndex + 1} / 10
              </h2>
              <h2 className="text-2xl text-green-800 mb-4">Score: {score} / 100</h2>
